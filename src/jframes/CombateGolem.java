 ...
 * @author kroctus
 */
public class CombateGolem extends javax.swing.JFrame {
 ...
 /*Esto nos permitora controlar que habilidad se ha seleccionado o no */
    ...
    /*Creamos al enemigo*/
    //Enemigo del primer capitulo
  
    private static Golem golem = new Golem("GOL´EM", "Tanque", new Arma(), 300.0, 0.0, 1, 500);
...
//        }
    ...
    private void initComponents() {
        ...
        partidaGuardada.setBounds(1110, 900, 340, 50);
        ...
        estapaCompletada.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/imagenes/subisteDeNivel3.png"))); // NOI18N
        ...
        labelEnemigo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/imagenes/golemReducido.png"))); // NOI18N
        ...
        getContentPane().add(libroBoton);
        libroBoton.setBounds(1450, 900, 60, 50);
 ...
 /*metodo que oculta las habilidades cuando no sea el turno del jugador*/
    ...
    public static void ataqueGolem() {

        if (golem.getDefensa() < 500 && contadorAtaques < 7) {
            Golem.pielDeRoca(golem);

        } else {

            Random aleo = new Random();
            int numero = aleo.nextInt(5);

            switch (numero) {
                case 0:
                    double daño = Golem.golpeRoca();
                    alice.perderVida(daño, alice);
                    break;
                case 1:
                    Golem.perderElTiempo();
                    break;

                case 2:
                    daño = Golem.golpeRoca();
                    alice.perderVida(daño, alice);
                    break;
                case 3:
                    Golem.perderElTiempo();
 ...
 /*Con esto conseguimos que cuando de seleccione un boton deiferente se muestre la descripción de este 
    ...
    private void slamButtomSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_slamButtomSActionPerformed
        ...
        if (bloqueo == false) {
            ...
            golem.quitarVida(daño, golem);
            turno = false;
            vidaFuggie.setText(golem.getVida().toString());
            magiaFuggie.setText(golem.getMp().toString());
            EscudoFuggie.setText(String.valueOf(golem.getDefensa()));
    ...
    private void rompeCorazonesButtomSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rompeCorazonesButtomSActionPerformed
        ...
        if (bloqueo == false) {
            ...
            ancelot.quebrantadorDeCorazones(golem);
            turno = false;
            vidaFuggie.setText(golem.getVida().toString());
            magiaFuggie.setText(golem.getMp().toString());
            EscudoFuggie.setText(String.valueOf(golem.getDefensa()));
    ...
    private void siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteActionPerformed
        Icon imgCombate;
        imgCombate = new ImageIcon(getClass().getResource("../imagenes/imagenes/interfazCombateRED2.png"));
 ...
 /*Devolvemos al inicio los styats del personaje*/
        ...
        new CombateGolem().setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CombateGolem.class
