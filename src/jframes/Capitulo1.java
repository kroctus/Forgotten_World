...
public class Capitulo1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/imagenes/charla1.png"))); // NOI18N
    ...
    private void siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteActionPerformed
        ...
        switch (contador) {
            case 0:
                img = new ImageIcon(getClass().getResource("../imagenes/imagenes/charla2.png"));
                fondo.setIcon(img);
                contador++;
                break;

            case 1:
                img = new ImageIcon(getClass().getResource("../imagenes/imagenes/capitulo1.png"));
                fondo.setIcon(img);
                contador++;
                break;
