 ...
 * @author kroctus
 */
public class InicioHistoria2 extends javax.swing.JFrame {

    /**
     * Creates new form InicioHistoria2
     */
    //Para controlar las interacciones del botón siguiente en la historia
    int contadorBoton = 0;

    public InicioHistoria2() {
        initComponents();
    }
    ...
    private void botonSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSiguienteActionPerformed
        ...
        switch (contadorBoton) {
            ...
            case 4:
                ...
                break;
            case 5:
                JOptionPane.showMessageDialog(null, "Empieza el juego historia alternativa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioHistoria2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
